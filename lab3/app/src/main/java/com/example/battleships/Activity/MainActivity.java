    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gameCreateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                reference.child(User.Id).child(User.Rank).child("imageType").setValue(User.ImageType);
                ...
                checkUser.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            User.EnemyImage = dataSnapshot.child(input).child("creator").child("imageType").getValue(String.class);
                            ...
                            reference.child(input).child(User.Rank).child("imageType").setValue(User.ImageType);
